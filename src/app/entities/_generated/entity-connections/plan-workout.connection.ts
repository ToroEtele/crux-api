...
@ObjectType()
export class PlanWorkoutConnection implements IConnection<PlanWorkout> {
  @GraphQLField(() => [PlanWorkout], { description: 'A list of nodes.' })
  public edges!: PlanWorkout[];

  @GraphQLField({ description: 'Information to aid in pagination.' })
  public pageInfo!: PageInfo;

  @GraphQLField(_type => Int, { description: 'Identifies the total count of PlanWorkouts in the connection.' })
  public totalCount!: number;
}

@ArgsType()
export class PlanWorkoutsArgs extends PaginationArgs {}

...
@ObjectType()
export class VerificationTokenConnection implements IConnection<VerificationToken> {
  @GraphQLField(() => [VerificationToken], { description: 'A list of nodes.' })
  public edges!: VerificationToken[];

  @GraphQLField({ description: 'Information to aid in pagination.' })
  public pageInfo!: PageInfo;

  @GraphQLField(_type => Int, { description: 'Identifies the total count of VerificationTokens in the connection.' })
  public totalCount!: number;
}

@ArgsType()
export class VerificationTokensArgs extends PaginationArgs {}

...
@ObjectType()
export class SubscriptionConnection implements IConnection<Subscription> {
  @GraphQLField(() => [Subscription], { description: 'A list of nodes.' })
  public edges!: Subscription[];

  @GraphQLField({ description: 'Information to aid in pagination.' })
  public pageInfo!: PageInfo;

  @GraphQLField(_type => Int, { description: 'Identifies the total count of Subscriptions in the connection.' })
  public totalCount!: number;
}

@ArgsType()
export class SubscriptionsArgs extends PaginationArgs {}

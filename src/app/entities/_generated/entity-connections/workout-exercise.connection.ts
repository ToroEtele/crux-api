...
@ObjectType()
export class WorkoutExerciseConnection implements IConnection<WorkoutExercise> {
  @GraphQLField(() => [WorkoutExercise], { description: 'A list of nodes.' })
  public edges!: WorkoutExercise[];

  @GraphQLField({ description: 'Information to aid in pagination.' })
  public pageInfo!: PageInfo;

  @GraphQLField(_type => Int, { description: 'Identifies the total count of WorkoutExercises in the connection.' })
  public totalCount!: number;
}

@ArgsType()
export class WorkoutExercisesArgs extends PaginationArgs {}

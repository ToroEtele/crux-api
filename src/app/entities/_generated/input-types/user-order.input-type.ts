...
import { UsersOrderField } from '../constants/user-order-field.enum';

@InputType()
export class UsersOrderInput implements ISort {
  @Field(_type => UsersOrderField, { description: 'The field to order Users by.' })
  public field!: UsersOrderField;

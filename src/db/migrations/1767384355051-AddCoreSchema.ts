...
export class AddCoreSchema1767384355051 implements MigrationInterface {
    name = 'AddCoreSchema1767384355051'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`birth_date\` datetime NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`country\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`city\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`max_grade_at_registration\` varchar(255) NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`max_grade\` varchar(255) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`max_grade\``);
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`max_grade_at_registration\``);
